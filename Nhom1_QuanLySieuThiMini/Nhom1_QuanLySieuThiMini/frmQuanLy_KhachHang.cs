...
{
    public partial class frmQuanLy_KhachHang : Form
    {
        DBConnect db;
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (grpSanPham.Enabled == false)
            {
                ...
                //string dem = "select count(MaKH) from KhachHang";
                //int stt = (int)db.getScalar(dem) + 1;
            ...
            else if (IsValidInput())
            {
                ...
                string sql = "INSERT INTO KhachHang (MaKH, TenKH, SDT_KH, DiaChi_KH) " + $"VALUES ('{maKH}', '{tenKH}', '{sdtKH}', '{diaChiKH}')";
        ...
        private void SaveEditedData()
        {
            ...
            string updateSql = $"UPDATE KhachHang SET TenKH = '{tenKH}', SDT_KH = '{sdtKH}', DiaChi_KH = '{diaChiKH}' WHERE MaKH = '{maKH}'";
